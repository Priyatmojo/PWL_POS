...
// confirm(\'Apakah Anda yakin menghapus data ini?\');">Hapus</button></form>';
    ...
    public function show_ajax(string $id) {
        ...
        return view('barang.show.ajax', ['barang' => $barang]);
    }
    ...
    public function delete_ajax(Request $request, string $id) {
        if ($request->ajax() || $request->wanstJson()) {
            $barang = BarangModel::find($id);
    ...
    public function export_excel() {
        ...
        $barang = BarangModel::select('kategori_id', 'barang_kode', 'barang_nama', 'harga_beli', 'harga_jual')
            ...
            ->with('kategori')
            ->get();
        // Load data barang yang akan diexport
        ...
        $sheet->getStyle('A1:F1')->getFont()->setBold(true);    // bolde header
        ...
        foreach (range('A','F') as $columnID) {
            $sheet->getColumnDimension($columnID)->setAutoSize(true); // ambil auto size untuk kolom
        }
        ...
        header('Cache-Control: chace, must-revalidate');
        header('Pragma: public');

        $writer->save('php://output');
        exit;
    } // end fucntion export_excel
    ...
    public function export_pdf() {
        ...
        // use Bartyvdh\DomPDF\Fecade\Pdf;
